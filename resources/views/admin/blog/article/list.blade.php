        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <h3 class="header smaller lighter blue">
                    {{trans('labels.blog.article.list')}}
                    @permission(config('admin.permissions.blog.article.create.name'))
                    <a href="{{route('admin.blog.article.create')}}" class="btn btn-sm btn-primary">{{trans('labels.add')}}</a>
                    @endpermission
                </h3>
