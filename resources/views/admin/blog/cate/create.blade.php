    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <!-- PAGE CONTENT BEGINS -->
                {!! Form::open(['route'=>'admin.blog.cate.store','method'=>'post','class'=>'form-horizontal','role'=>'form']) !!}
                    <div class="form-group">
                        {!! Form::label('name',trans('labels.blog.cate.name'),['class'=>'col-sm-3 control-label no-padding-right']) !!}
                        <div class="col-sm-9">
                            {!! Form::text('name',old('name'),['class'=>'col-xs-10 col-sm-5','id'=>'name','placeholder'=>trans('labels.blog.cate.name')]) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('pid',trans('labels.blog.cate.pid'),['class'=>'col-sm-3 control-label no-padding-right']) !!}
                        <div class="col-sm-9">
                            {!! Form::select('pid',$cates,null,['class'=>'col-xs-10 col-sm-5 chosen-select','data-placeholder'=>trans('labels.blog.cate.pid')]) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('sort',trans('labels.blog.cate.sort'),['class'=>'col-sm-3 control-label no-padding-right']) !!}
                        <div class="col-sm-9">
                            {!! Form::number('sort',old('sort'),['class'=>'col-xs-10 col-sm-5','id'=>'sort','placeholder'=>trans('labels.blog.cate.sort')]) !!}
                        </div>
                    </div>
                    <div class="clearfix">
