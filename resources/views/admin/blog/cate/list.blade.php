        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <h3 class="header smaller lighter blue">
                    {{trans('labels.blog.cate.list')}}
                    @permission(config('admin.permissions.blog.cate.create.name'))
                    <a href="{{route('admin.blog.cate.create')}}" class="btn btn-sm btn-primary">{{trans('labels.add')}}</a>
                    @endpermission
                </h3>
                <div class="table-responsive">
                    <div id="sample-table-2_wrapper" class="dataTables_wrapper" role="grid">
                        <table id="cate" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
                            <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" style="width: 162px;">
                                    {{trans('labels.blog.cate.name')}}
                                </th>
                                <th class="sorting" style="width: 162px;">
                                    {{trans('labels.blog.cate.pid')}}
                                </th>
                                <th class="sorting" style="width: 162px;">
                                    {{trans('labels.blog.cate.sort')}}
                                </th>
...
@section('js')
    <script  src="{{asset('backend/admin/blog/cate/dataTables.js')}}" type="text/javascript"></script>
